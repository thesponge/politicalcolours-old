...
function init()
{
    var control, action, toolbarItems = [],
        footerbarItems = [];
    var layerOne = '2008 - 2012 Senate<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;   - Rebel voting';
    ...
    var lSen2008Rebel = new OpenLayers.Layer.WMS(layerOne, wmsUrl, {
    ...
    var mapLayers = [lOpenStreetMap, lSen2008Rebel,  hover, lAdminBorderSen, lAdminBorderLabelSen];
