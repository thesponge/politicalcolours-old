...
function init()
{
	...
	var lStat2010Sal = new OpenLayers.Layer.WMS(layerOne, wmsUrl, {
    ...
    var mapLayers = [lOpenStreetMap, lStat2010Sal, lAdminBorder, hover, lAdminBorderLabel];
    ...
    var layerOneProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lStat2010Sal, {
        featurePrefix: "omc",
