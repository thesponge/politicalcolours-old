...
function init()
{
    var control, action, toolbarItems = [],
        footerbarItems = [];
    var layerOne = '2011 Households Census <br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; (preliminary data)';
    ...
    var lStat2011House = new OpenLayers.Layer.WMS(layerOne, wmsUrl, {
    ...
    var mapLayers = [lOpenStreetMap, lStat2011House, lAdminBorder, hover, lAdminBorderLabel];
    ...
    var layerOneProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lStat2011House, {
        featurePrefix: "omc",
