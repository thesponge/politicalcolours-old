...
function init()
{
    var control, action, toolbarItems = [],
        footerbarItems = [];
    var layerOne = '2008 - 2012 Senate<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;   - Electronic voting presence';
    ...
    var lSen2008Presence = new OpenLayers.Layer.WMS(layerOne, wmsUrl, {
    ...
    var mapLayers = [lOpenStreetMap, lSen2008Presence,  hover, lAdminBorderSen, lAdminBorderLabelSen];
    ...
    var layerOneProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lSen2008Presence, {
        featurePrefix: "omc",
