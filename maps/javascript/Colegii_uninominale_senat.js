...
function init()
{
	...
	lSen2008 = new OpenLayers.Layer.Vector(layerOne, {
    ...
    var mapLayers = [lOpenStreetMap, lSen2008, lAdminBorderSen];
	...
	lSen2008.events.register('loadend', lSen2008, function() {
		found_feature = lSen2008.features[0];
