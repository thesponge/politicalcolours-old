 ...
 *  ------------
 */
var activeLayer = '2012 - Municipality Mayor';
var layerOne = '2012 - Municipality Mayor';
var layerTwo = '2012 - County Council<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; President';
var layerThree = '2012 - Municipality Mayor<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; (True Colours)';

var filterOne = '1 = 1';
var filterTwo = ' AND 1 = 1';
var filterTwoBis = ' AND 1 = 1';
...
Ext.onReady(function() {
    ...
    var lPrimariInfluence2012 = new OpenLayers.Layer.WMS(layerThree, wmsUrl, {
        layers: 'omc:ro_uat_primari_2012',
        transparent: true,
        format: 'image/png',
        width: 512,
    ...
    var lPresedintiCJ2012 = new OpenLayers.Layer.WMS(layerTwo, wmsUrl, {
    ...
    var mapLayers = [lOpenStreetMap, lPresedintiCJ2012, lPrimariInfluence2012, lPrimari2012, hover, lAdminBorder, lAdminBorderLabel];

    //map
    var map = new OpenLayers.Map(mapOptions);
    map.addLayers(mapLayers);
    lPrimariInfluence2012.setVisibility(false);
    lPresedintiCJ2012.setVisibility(false);
    ...
    var layerThreeProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lPrimariInfluence2012, {
        featurePrefix: "omc",
        featureNS: "http://www.opengeospatial.net/omc",
        featureType: "ro_uat_primari_2012",
        geometryName: "the_geom",
    ...
    var layerTwoProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lPresedintiCJ2012, {
        featurePrefix: "omc",
        featureNS: "http://www.opengeospatial.net/omc",
    ...
    featureInfo.events.register("featuresselected", this, function(e) {
        ...
        } else if (activeLayer == layerThree) {
            var content = '<div id="info" style="padding:3px 5px 3px 5px; font-size: 12px; font-family: verdana, sans-serif;width:350px;word-wrap: break-word;">';
    ...
    judeteCombo.on('select', function(box, record, index) {
        ...
        lPrimari2012.mergeNewParams({
            'CQL_FILTER': filterOne + filterTwo
        });
        lPrimariInfluence2012.mergeNewParams({
            'CQL_FILTER': filterOne + filterTwoBis
        });
        lPresedintiCJ2012.mergeNewParams({
            'CQL_FILTER': filterOne + filterTwo
        });
    ...
    partideCombo.on('select', function(box, record, index) {
        if (record.data.id_partid == 0) {
            filterTwo = ' AND 1 = 1';
            filterTwoBis = ' AND 1 = 1';
        } else {
            filterTwo = " AND id_partid = '" + record.data.id_partid + "'";
            filterTwoBis = " AND id_partid_principal = '" + record.data.id_partid + "'";
            hover.removeAllFeatures();
            document.getElementById('infobox').style.display = "none";
        }
	...
	//global opacity
	lPrimari2012.setOpacity(layerOpacity/100);
        ...
        if (evt.property === "visibility") {
            if (evt.layer.visibility) {
                if (evt.layer.name == layerOne || evt.layer.name == layerTwo || evt.layer.name == layerThree) {
                    ...
                    if (evt.layer.name == layerOne) {
                        featureInfo.protocol = layerOneProtocol;
                    } else if (evt.layer.name == layerThree) {
                        featureInfo.protocol = layerThreeProtocol;
                    } else {
                        featureInfo.protocol = layerTwoProtocol;
                    }
