...
function ccp_init() {
    var control, action, toolbarItems = [],
        footerbarItems = [];
    var layerOne = '2008 - 2012 Chamber<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;  of Deputies - Electronic voting<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; presence';
    ...
    var lCDep2008Presence = new OpenLayers.Layer.WMS(layerOne, wmsUrl, {
    ...
    var mapLayers = [lOpenStreetMap, lCDep2008Presence, hover, lAdminBorderDep, lAdminBorderLabelDep];
    ...
    var layerOneProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lCDep2008Presence, {
        featurePrefix: "omc",
