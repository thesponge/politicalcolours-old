 ...
 *  ------------
 */
var activeLayer = '2008 - 2012 Senate';
var layerOne = '2008 - 2012 Senate';
var layerTwo = '2008 - 2012 Senate<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;   - Electronic voting presence';
var layerThree = '2008 - 2012 Senate<br/>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;   - Rebel voting';
...
Ext.onReady(function() {
    ...
    var lSen2008Presence = new OpenLayers.Layer.WMS(layerTwo, wmsUrl, {
        layers: 'omc:ro_senatori_2008',
        transparent: true,
        format: 'image/png',
        width: 512,
    ...
    var lSen2008Rebel = new OpenLayers.Layer.WMS(layerThree, wmsUrl, {
        layers: 'omc:ro_senatori_2008',
        transparent: true,
        format: 'image/png',
        width: 512,
    ...
    var mapLayers = [lOpenStreetMap, lSen2008Rebel, lSen2008Presence, lSen2008, hover, lAdminBorderSen, lAdminBorderLabelSen];

    //map
    var map = new OpenLayers.Map(mapOptions);
    map.addLayers(mapLayers);
    lSen2008Presence.setVisibility(false);
    lSen2008Rebel.setVisibility(false);
    ...
    var layerOneProtocol = OpenLayers.Protocol.WFS.fromWMSLayer(lSen2008Rebel, {
        featurePrefix: "omc",
    ...
    judeteCombo.on('select', function(box, record, index) {
        ...
        lSen2008.mergeNewParams({
            'CQL_FILTER': filterOne + filterTwo
        });
        lSen2008Presence.mergeNewParams({
            'CQL_FILTER': filterOne + filterTwo
        });
        lSen2008Rebel.mergeNewParams({
            'CQL_FILTER': filterOne + filterTwo
        });
	...
	//global opacity
	lSen2008.setOpacity(layerOpacity/100);
