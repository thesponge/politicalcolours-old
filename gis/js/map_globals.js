...
var judeteJsonURL = webSiteURL + "data/json.php?mode=judete";
var partide2012JsonURL = webSiteURL + "data/json.php?mode=partide";
var partide2008SenatJsonURL = webSiteURL + "data/json.php?mode=partide_senat_2008";
var partide2008CDepJsonURL = webSiteURL + "data/json.php?mode=partide_deputati_2008";

var searchLocationURL = webSiteURL + "data/json.php?mode=map_search_location";
var legendURL_1loc = webSiteURL + "/gis/html/legend_1loc.html";
var legendURL_2dep = webSiteURL + "/gis/html/legend_2dep.html";
var legendURL_3sen = webSiteURL + "/gis/html/legend_3sen.html";
var legendURL_4stat = webSiteURL + "/gis/html/legend_4stat.html";
