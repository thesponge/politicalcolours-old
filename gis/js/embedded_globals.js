...
var lOpenStreetMap = new OpenLayers.Layer.TileCache("OpenStreetMap", [tilecacheUrl], "omc_osm", {
    ...
    visibility: true,
    attribution: '</br>Map data &#169; OpenStreetMap contributors' //+ curDate.getFullYear() //2011'
});
...
var lAdminBorderLabel = new OpenLayers.Layer.WMS("Label", wmsUrl, {
...
var hover = new OpenLayers.Layer.Vector("Hover", {
    styleMap: styleOMC,
    displayInLayerSwitcher: false,
	    attribution: '<a href="http://www.politicalcolours.ro/colab.html" style="color:#fff;" target="_blank"> Copyright Notice</a>' //+ curDate.getFullYear() //2011'
}, _layer_option2);
